...
- Do not change npm trusted publishing, Chrome Web Store publication, browser ownership, or the agent-browser `0.33.0` compatibility group. The Release workflow remains the protected publication boundary, but Prepare Release may dispatch it after a successful merge.
