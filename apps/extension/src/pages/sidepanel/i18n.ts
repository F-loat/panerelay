...
export const copy = {
  en: {
    ...
    setBrowserDefault: 'Use this browser by default',
    clearBrowserDefault: 'Clear this browser as default',
  ...
  'zh-CN': {
    ...
    setBrowserDefault: '将当前浏览器设为默认',
    clearBrowserDefault: '取消当前默认浏览器',
