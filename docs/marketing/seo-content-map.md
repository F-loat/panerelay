...
| P1 | agent-browser existing Chrome | agent-browser provider Chrome profile; agent-browser logged-in tabs | `/` plus `packages/agent-browser/README.md` | How can agent-browser operate explicitly authorized daily-browser tabs? | Provider setup, 0.33.0 compatibility |
| P1 | Browser Use existing Chrome session | Browser Use CDP existing browser; Browser Use real Chrome profile | `/compare/` plus `packages/browser-use/README.md` | Which Browser Use connection mode fits an existing session? | Browser Use CLI docs, exact baseline |
