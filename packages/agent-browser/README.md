...
Browser Provider adapter that lets agent-browser use explicitly authorized tabs in a running Chrome profile through Panerelay.
...
agent-browser 0.33.0 is the minimum supported version and initial verified baseline. Newer versions satisfy the version floor but need their own compatibility evidence before being classified as verified.
